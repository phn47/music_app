  ...
  const handleHideArtist = async () => {
    try {
      ...
      const response = await fetch(
        `http://127.0.0.1:8000/auth/approvenull/${artist.id}`,
        {
          method: "POST",
          headers: {
      ...
      if (!response.ok) throw new Error("Không thể ẩn thông tin nghệ sĩ.");

      setAlert({
        show: true,
        message: 'Đã ẩn thông tin nghệ sĩ thành công.',
        type: 'success'
      });
  ...
  return (
    <div className="container py-5">
          ...
          <div className="card shadow-lg border-0 overflow-hidden fade-in-up">
            ...
            <div className="card-header text-white text-center py-4 gradient-animation">
              ...
              <div className="position-relative">
                ...
                />
                <span className="position-absolute badge bg-success rounded-pill bounce"
                  style={{
                    zIndex: 10,
                    padding: "8px 15px",
                    fontSize: "0.9rem",
            ...
            <div className="card-body p-4">
              <div className="text-center mb-4 slide-in-right">
                ...
                <p className="text-muted mb-3">
                  <i className="fas fa-user-check me-2 bounce"></i>
                  Nghệ sĩ đã được duyệt
                </p>
              </div>
              ...
              <div className="bg-light p-4 rounded-3 hover-effect mb-4 slide-in-left">
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-md-8">
                    <p className="mb-0">{new Date(artist.created_at).toLocaleDateString('vi-VN') || "Không rõ"}</p>
                  </div>
                </div>
              </div>
      ...
      <style jsx>{`
        ...
        .gradient-animation {
          background: linear-gradient(45deg, #198754, #157347, #198754);
...
export default PhieuArtTruePage;
